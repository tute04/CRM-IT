...
export default function InventarioPage() {
    ...
    const handleDelete = async () => {
        ...
        const { error } = await supabase.from('productos').delete().eq('id', deleteConfirmId);
    ...
    return (
        <div className="space-y-5 max-w-7xl mx-auto animate-fade-in">
            ...
            {filtered.length === 0 ? (
                <EmptyState
                    title="Sin productos"
                    description={search ? 'No se encontraron resultados para tu búsqueda.' : 'Agregá tu primer producto al inventario.'}
                    action={
                        !search && (
            ...
            <Modal isOpen={!!deleteConfirmId} onClose={() => setDeleteConfirmId(null)} title="¿Eliminar producto?">
                <div className="space-y-4">
