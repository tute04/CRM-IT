        ...
        <div className="bg-neutral-950 p-6 rounded-xl shadow-lg border border-neutral-800 transition-colors duration-300 h-full flex flex-col">
            ...
            {!loading && resultados.length > 0 && (
                <div className="flex-1 overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-neutral-700 scrollbar-track-transparent pb-4 space-y-4">
                    ...
                    <button onClick={copiarWhatsApp} className="mt-6 flex items-center justify-center gap-2 w-full py-4 text-yellow-500 border border-yellow-500/50 hover:bg-yellow-400/10 hover:border-yellow-400 font-black rounded-xl uppercase tracking-widest transition-all shadow-sm">
